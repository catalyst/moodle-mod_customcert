...
use mod_customcert\task\email_certificate_adhoc_task;
 ...
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_customcert\task\email_certificate_adhoc_task
 */
final class email_certificate_task_test extends advanced_testcase {
     ...
     * @covers \mod_customcert\task\email_certificate_adhoc_task
     */
    ...
    public function test_email_certificates_adhoc(): void {
        ...
        $task = new email_certificate_adhoc_task();
     ...
     * @covers \mod_customcert\task\email_certificate_task
     */
    public function test_email_certificate_task_creates_issue_when_none_exist(): void {
        global $CFG, $DB;
    ...
    /**
     * The email_certificate_adhoc_task should no-op (not fatal) when custom data is missing.
     *
     * @covers \mod_customcert\task\email_certificate_adhoc_task
     */
    public function test_email_adhoc_task_ignores_missing_customdata(): void {
        ...
        $task = new \mod_customcert\task\email_certificate_adhoc_task();
    ...
    /**
     * The email_certificate_adhoc_task should no-op when customcert id is invalid.
     *
     * @covers \mod_customcert\task\email_certificate_adhoc_task
     */
    ...
    /**
     * The email_certificate_adhoc_task should no-op when issue id is invalid (even if customcert exists).
     *
     * @covers \mod_customcert\task\email_certificate_adhoc_task
     */
